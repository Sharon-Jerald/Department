    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col" col-12 col-xs-4 col-sm-4 col-md--4 col-lg-4 col-xl-4 col-xxl-4>
                <img height="200px" src="image/lib4.jpg" class="d-block w-100" alt="...">
            </div>
        
            <div class="col" col-12 col-xs-4 col-sm-4 col-md--4 col-lg-4 col-xl-4 col-xxl-4>
                <img height="200px" src="image/lib.jpg" class="d-block w-100" alt="...">
            </div>
        
            <div class="col" col-12 col-xs-4 col-sm-4 col-md--4 col-lg-4 col-xl-4 col-xxl-4>
                <img height="200px" src="image/lib3.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
    </div> 
